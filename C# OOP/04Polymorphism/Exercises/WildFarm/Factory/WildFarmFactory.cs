...
namespace WildFarm.Factory
{
    ...
    {
        public IAnimal CreateAnimal(string type, string name, double weight)
        {
            IAnimal animal = null;

            if (type == nameof(Owl))
            {
                animal = new Owl(name, weight);
            }
            else if (type == nameof(Hen))
            {
                animal = new Hen(name, weight);
            }
            else if (type == nameof(Mouse))
            {
                animal = new Mouse(name, weight);
            }
